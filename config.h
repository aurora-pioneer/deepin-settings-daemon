...
/* Define if GConf bridge should be built */
/* #undef BUILD_GCONF_BRIDGE */
...
/* Define if PackageKit should be used */
/* #undef HAVE_PACKAGEKIT */
...
#define PACKAGE_STRING "gnome-settings-daemon 3.4.2"
